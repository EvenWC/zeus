package com.wangcheng.zeus.core.config.social.process.filter;
...
* @author Yuan Ji
*/
public class ZeusSocialAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public ZeusSocialAuthenticationFilter(AuthenticationManager authManager, UserIdSource userIdSource, UsersConnectionRepository usersConnectionRepository, SocialAuthenticationServiceLocator authServiceLocator) {
        ...
        super.setAuthenticationFailureHandler(new SocialAuthFailureHandler(delegateAuthenticationFailureHandler));
        super.setAuthenticationSuccessHandler(new SocialAuthSuccessHandler());
    }
    ...
    protected boolean detectRejection(HttpServletRequest request) {
        ...
        return parameterKeys.size() > 0
                ...
                && !parameterKeys.contains("sessionId")
